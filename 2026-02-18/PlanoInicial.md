### "Plano inicial de Tecnologia da Informação demonstrando como a TI se alinha ou poderia se alinhar à organizacional da empresa escolhida, apresentando como as decisões que apoiam os processos internos, contribuem para competitividade e fortalecem os objetivos estratégicos da organização"
<br>
...
Alguns pontos relevantes são: a integração de dados, a automação de processos e ferramentas de Business Intelligence (BI).
Essas decisões garantem um maior eficiência operacional, redução de custos, agilidade na resposta ao mercado e  melhor experiência ao consumidor.


### ⚔️ 5.2. Competitividade 
A competitividade da Disney é fortalecida pela inovação contínua. Isso abrange questões de efeitos visuais, animações, experiências imersivas, atrações e meios de comunicação.
A empresa possui uma experiência integrada entre produtos físicos, como os parques e produtos licenciados e digitais, como as plataformas de streaming e a Rádio Disney.
A combinação entre tecnologia, marca consolidada e portfólio diversificado é capaz de gerar uma vantagem competitiva no setor de entretenimento global.
